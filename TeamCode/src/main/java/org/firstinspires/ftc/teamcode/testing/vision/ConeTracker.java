...
public class ConeTracker extends OpenCvPipeline {
    ...
    private final double cameraHeight = 480;
    ...
    public ConeTracker(Telemetry telemetry, boolean RED, boolean BLUE) {
    ...
    public int getRedRectX(){
        return RedRect.x;
    }



    public int getBlueRectX(){
        return BlueRect.x;
    }

    public int getRedRectY(){
        return RedRect.y;
    }

    public int getBlueRectY(){
        return BlueRect.y;
    }

    public double getCorrectedRedRectX(){
        return (getRedRectX() - (cameraWidth / 2));
    }
    public double getRedConeAngle() { return -(getCorrectedRedRectX() * pixelsPerDegreeX);  }

    public double getCorrectedBlueRectX(){
        return (getBlueRectX() - (cameraWidth / 2));
    }

    public double getCorrectedRedRectY(){
        return (getRedRectY() - (cameraHeight / 2));
    }

    public double getCorrectedBlueRectY(){
        return (getBlueRectY() - (cameraHeight / 2));
    }
}
