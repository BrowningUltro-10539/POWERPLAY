...
public class AutoCycleCommandV7Medium extends SequentialCommandGroup {
    public AutoCycleCommandV7Medium(Robot robot, TrajectorySequence toPole, TrajectorySequence toConeStack, double slideHeight){
        super(
