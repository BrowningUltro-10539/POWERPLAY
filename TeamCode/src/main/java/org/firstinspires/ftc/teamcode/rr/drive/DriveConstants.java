...
public class DriveConstants {
    ...
    public static double GEAR_RATIO = 1 * 0.9989; // output (wheel) speed / input (motor) speed
    public static double TRACK_WIDTH = 14.1601; // in
     ...
     * empirically tuned.
     */
    public static double kV = 0.012516258833585406;
    public static double kA = 0.00448;
