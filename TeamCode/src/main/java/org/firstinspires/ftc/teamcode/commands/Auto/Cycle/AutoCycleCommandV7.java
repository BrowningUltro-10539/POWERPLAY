...
public class AutoCycleCommandV7 extends SequentialCommandGroup {
    public AutoCycleCommandV7(Robot robot, TrajectorySequence toPole, TrajectorySequence toConeStack, double slideHeight){
        super(
